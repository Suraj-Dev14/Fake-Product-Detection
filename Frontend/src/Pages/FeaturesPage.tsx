...
import { Shield, QrCode, BarChart, Zap, Globe, Smartphone, Clock, Users } from "lucide-react";
      ...
      <section className="bg-linear-to-br from-blue-50 to-purple-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to protect your products and build customer trust
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Generate unique, tamper-proof QR codes for each product. Each code is cryptographically 
              secured and linked to your product database.
            </p>
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Mobile-First Verification</h3>
            <p className="text-gray-600 mb-4">
              Customers can verify products instantly using their smartphone camera. No app 
              download required.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Track verification attempts, detect counterfeit patterns, and gain insights 
              into your product distribution.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Immutable records stored on blockchain ensure verification data cannot be 
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Integrate with your existing systems via REST API or use our ready-made 
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Our service works worldwide with support for multiple languages and 
              currencies, perfect for international brands.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
              <li>• 50+ languages</li>
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Product Lifecycle Tracking</h3>
            <p className="text-gray-600 mb-4">
              Track products from manufacturing to end consumer. Monitor supply chain 
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Invite team members with role-based permissions. Collaborate efficiently 
              with your quality and security teams.
            </p>
            <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Custom Verification Pages</h3>
            <p className="text-gray-600 mb-4">
              Create branded verification pages that match your brand identity. Build 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                Generate thousands of QR codes at once. Upload product data via CSV 
                and generate codes in bulk for large product runs.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                Generate detailed reports on verification patterns, geographic distribution, 
                and counterfeit detection rates.
              </p>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                Receive instant notifications when suspicious activity is detected, such 
                as multiple scans from different locations.
              </p>
              <ul className="space-y-2 text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                Create custom verification workflows tailored to your business processes 
      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Protect your brand and customers with our powerful verification platform
          </p>
